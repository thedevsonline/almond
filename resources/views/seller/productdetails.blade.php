    ...
    <form action="{{route('add_cart',$product->id)}}" >
        ...
        <div class="input-group quantity mr-3" style="width: 130px;">
            <div class="input-group">
                ...
                <<?php 
                $totaprice=1;
                  $totaprice=  $product->minmum_sell *  $totaprice * $product->product_price; 
                 ?>

                <input class="form-control bg-secondary border-0 px-1 text-center" max="{{$product->stock }}" name="quantity" type="text" min="{{$product->minmum_sell}}" id="input-value" value="{{$totaprice}}">
