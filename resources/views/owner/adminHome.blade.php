...
<html lang="en">
  ...
  @vite('resources/assets/vendors/mdi/css/materialdesignicons.min.css')
    ...
    @vite('resources/assets/assets/vendors/owl-carousel-2/owl.theme.default.min.css')
    @vite('resources/assets/vendors/jvectormap/jquery-jvectormap.css')
    @vite('resources/assets/assets/vendors/owl-carousel-2/owl.carousel.min.css')
  ...
  <body>
    ...
    @vite('resources/assets/vendors/owl-carousel-2/owl.carousel.min.js')

    @vite('resources/assets/vendors/js/vendor.bundle.base.js')
    @vite('resources/assets/vendors/progressbar.js/progressbar.min.js')
    @vite('resources/assets/vendors/jvectormap/jquery-jvectormap.min.js')
    ...
    @vite('resources/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js')
